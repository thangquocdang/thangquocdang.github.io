...
Với:
$$p_c$$: cho biết có bất kỳ đối tượng nào trong ảnh hay không 
$$b_x,b_y,b_w,b_h$$: sẽ cho biết vị trí của bouding box của đối tượng
$$c_1,c_2,c_3$$: nhãn của đối tượng trong ảnh tương ứng với class 1, class 2, class 3
